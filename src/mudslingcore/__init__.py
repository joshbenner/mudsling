...
class MUDSlingCorePlugin(GamePlugin, areas.AreaProviderPlugin):
    ...
    def __init__(self, game, entry_point, manager):
        super(MUDSlingCorePlugin, self).__init__(game, entry_point, manager)
    ...
    def server_startup(self):
        ...
        mail_db_uri = config.getstr('MUDSlingCore Mail', 'mail db uri')
        mail.mail_db = mail.MailDB(mail_db_uri, self.game)
